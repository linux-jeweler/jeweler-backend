...
beforeAll(() => {
  fs.rmSync('./__tests__/unit/HelperTests/.Files', {
    recursive: true,
    force: true,
  });
  fs.mkdirSync('./__tests__/unit/HelperTests/.Files', { recursive: true });
  fs.writeFileSync(
    './__tests__/unit/HelperTests/.Files/test_2024-04-29.json',
    'test'
  );
  fs.writeFileSync(
    './__tests__/unit/HelperTests/.Files/test_' + today + '.json',
    'test'
  );
});
